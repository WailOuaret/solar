...
def main() -> None:
    parser = argparse.ArgumentParser(description="Preprocess DeepSolarEye images into the processed directory.")
    ...
    out_dir = resolve_project_path(config["datasets"]["deepsolareye"]["processed_dir"])
    ensure_dir(out_dir)
    ...
    print(f"Preprocessed {len(subset)} DeepSolarEye images to {out_dir}")
